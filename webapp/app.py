...
def dashboard():
    ...
    return render_template(
        ...
        category_names=cols["category_names"], totals=totals_list,
    )
...
def add_entry():
    try:
        ...
        flash(str(e), "err")
        return render_template(
            "add_entry.html", active_page="add", employees=[], categories=[],
